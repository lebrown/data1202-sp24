            ...
            for i in exceptionClass:
                ...
                if (key in str(value)):
                    ...
                    for j in items.get("helptext"):
                        ...
                        c += 1
    def data8(self):
        display(Markdown("The DATA 1202 Reference might be helpful to look over for examples and usage: [DATA 1202 Reference](https://pages.mtu.edu/~lebrown/data1202-s24/reference/index.html)"))
